...
![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image1.png | width=70)
       
        
        
### 2. Click “Edit and Deploy New Revision”
        
![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image2.png | width=70)
...
![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image3.png | width=70)    
        
### 4. Enable HTTP/2
        
Ensure that you have Redis Enterprise Cloud DB created under GCP.
        
![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image_4.png | width=70)

### 5. Allow all the traffic
        
![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image_5.png | width=70)

 ### 6. Access Rate Limiting app

![ratelimiting](https://raw.githubusercontent.com/redis-developer/basic-rate-limiting-demo-python/master/image_6.png | width=70)
